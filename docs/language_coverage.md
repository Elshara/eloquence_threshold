...
Generated at: 2025-09-30T00:28:21Z
...
| Locale | Profile | Characters | Templates | IPA coverage | Status |
| --- | --- | --- | --- | --- | --- |
| (unspecified) | — | 0 | espeak-variant-espeak-variants-alex | — | Templates only |
| am | Amharic – ejective cadence – am – Placeholder emphasising Amharic ejectives and the seven-syllable abugida patterns. (`am-et-seed`) | 3 | eloquence-seed-am-et | 33% | Profile + templates |
| ar | Arabic (Modern Standard) – emphatic backbone – ar – Seeded MSA profile capturing emphatic coronals and the sun/moon assimilation patterns. (`ar-msa-seed`) | 3 | eloquence-seed-ar-msa | 0% | Profile + templates |
| ar-EG | Arabic (Egyptian) – colloquial glide – ar-EG – Captures Cairene consonant shifts (gīm→/g/, qāf→/ʔ/) so phoneme EQ can mimic everyday Egyptian Arabic. (`ar-eg-seed`) | 3 | eloquence-seed-ar-eg | 33% | Profile + templates |
| bn | Bengali – retroflex melody – bn – Bengali placeholder emphasising retroflex flaps, palatal fricatives, and nasal vowels. (`bn-bd-seed`) | 3 | eloquence-seed-bn-bd | 67% | Profile + templates |
| cs | Czech – trill precision – cs – Czech placeholder emphasising the ř trill, velar fricative ch, and palatal nasals. (`cs-cz-seed`) | 3 | eloquence-seed-cs-cz | 33% | Profile + templates |
| da | Danish – stød scaffolding – da – Danish placeholder highlighting stød, uvular r, and vowel reductions. (`da-dk-seed`) | 3 | eloquence-seed-da-dk | 33% | Profile + templates |
| de-DE | German – precise articulation – de-DE – Key German letters referencing eSpeak de voice (`de-de-basic`) | 11 | espeak-de-precision | 27% | Profile + templates |
| el | Greek – consonant balance – el – Greek placeholder emphasising dental fricatives, velar fricatives, and consonant clusters. (`el-gr-seed`) | 3 | eloquence-seed-el-gr | 33% | Profile + templates |
| en-GB | English (UK) – clipped clarity – en-GB – Receives vowels tuned for eSpeak en-gb (`en-gb-basic`) | 6 | espeak-en-gb-clarity | 40% | Profile + templates |
| en-US | English (US) – tactile vowels – en-US – Foundational Latin alphabet mapping derived from eSpeak en-us (`en-us-basic`) | 8 | dectalk-perfect-paul, dectalk-beautiful-betty, dectalk-rough-rita, … (18 total) | 25% | Profile + templates |
| en-US | English (US) – Heritage Eloquence – en-US – Pronunciation cues transcribed from JAWS, Window-Eyes, and Loquence studio dictionaries (`en-us-heritage`) | 13 | dectalk-perfect-paul, dectalk-beautiful-betty, dectalk-rough-rita, … (18 total) | 50% | Profile + templates |
| es-419 | Spanish (LatAm) – sonorous core – es-419 – Latin American Spanish vowels and consonants following eSpeak es-la (`es-419-basic`) | 7 | espeak-es-latin | 29% | Profile + templates |
| es-ES | Spanish (Castilian) – crisp sibilants – es-ES – Castilian defaults matching eSpeak es (`es-es-basic`) | 5 | espeak-es-castilian | 60% | Profile + templates |
| fa | Persian (Farsi) – smooth ezafe – fa – Seeded Persian profile that foregrounds ezafe liaisons and the soft postalveolar fricatives common in Tehrani speech. (`fa-ir-seed`) | 3 | eloquence-seed-fa-ir | 67% | Profile + templates |
| fi | Finnish – vowel length discipline – fi – Finnish placeholder covering vowel length contrasts, front rounded vowels, and velar nasals. (`fi-fi-seed`) | 3 | eloquence-seed-fi-fi | 67% | Profile + templates |
| fil | Filipino – Tagalog clarity – fil – Filipino placeholder addressing velar nasals, Spanish ñ loans, and affricate onsets. (`fil-ph-seed`) | 3 | eloquence-seed-fil-ph | 67% | Profile + templates |
| fr-FR | French – nasal warmth – fr-FR – Core French characters tuned against eSpeak fr defaults (`fr-fr-basic`) | 15 | espeak-fr-velvet | 33% | Profile + templates |
| gu | Gujarati – vocalic resonances – gu – Gujarati placeholder emphasising retroflex laterals, palatal nasals, and vocalic r vowels. (`gu-in-seed`) | 3 | eloquence-seed-gu-in | 100% | Profile + templates |
| ha | Hausa – vibrant glottalic stops – ha – Captures Hausa ejective stops and high/low tone contrasts for the Latin orthography. (`ha-ng-seed`) | 3 | eloquence-seed-ha-ng | 33% | Profile + templates |
| he | Hebrew – modern articulation – he – Modern Israeli Hebrew placeholder accentuating uvular frication and ejective-like tsadi bursts. (`he-il-seed`) | 3 | eloquence-seed-he-il | 33% | Profile + templates |
| hi-IN | Hindi – retroflex energy – hi-IN – Core Devanagari characters tuned against eSpeak hi phonemes (`hi-in-basic`) | 5 | espeak-hi-dynamic | 40% | Profile + templates |
| id | Indonesian – archipelago clarity – id – Indonesian placeholder capturing prenasalised onsets and clear loan consonants. (`id-id-seed`) | 3 | eloquence-seed-id-id | 100% | Profile + templates |
| it-IT | Italian – open vowels – it-IT – Italian vowel core tied to eSpeak it voice (`it-it-basic`) | 15 | espeak-it-expressive | 47% | Profile + templates |
| ja-JP | Japanese – mora rhythmic – ja-JP – Kana coverage with pitch-accent guidance for NVDA phoneme hints (`ja-jp-basic`) | 5 | espeak-ja-melodic | 0% | Profile + templates |
...
| zu | Zulu – click-rich texture – zu – Zulu placeholder mixing click consonants with lateral fricatives to prep the phoneme editor. (`zu-za-seed`) | 3 | eloquence-seed-zu-za | 33% | Profile + templates |
...
### Bengali – retroflex melody – bn – Bengali placeholder emphasising retroflex flaps, palatal fricatives, and nasal vowels. (bn)
...
### Greek – consonant balance – el – Greek placeholder emphasising dental fricatives, velar fricatives, and consonant clusters. (el)
...
### English (US) – Heritage Eloquence – en-US – Pronunciation cues transcribed from JAWS, Window-Eyes, and Loquence studio dictionaries (en-US)
...
### Persian (Farsi) – smooth ezafe – fa – Seeded Persian profile that foregrounds ezafe liaisons and the soft postalveolar fricatives common in Tehrani speech. (fa)
...
### Gujarati – vocalic resonances – gu – Gujarati placeholder emphasising retroflex laterals, palatal nasals, and vocalic r vowels. (gu)
...
### Indonesian – archipelago clarity – id – Indonesian placeholder capturing prenasalised onsets and clear loan consonants. (id)
...
### Malayalam – retroflex waves – ml – Malayalam placeholder tuned for retroflex approximants, nasal clusters, and geminated stops. (ml)
...
### Norwegian (Bokmål) – tonal balance – nb – Norwegian placeholder capturing palatal kj, retroflex skj, and pitch accent pairs. (nb)
...
### Polish – sibilant contrast – pl – Polish placeholder emphasising alveolo-palatal vs retroflex sibilants and dark ł vowels. (pl)
...
### Sinhala – rounded cadence – si – Sinhala placeholder emphasising prenasalised stops, palatal nasals, and loan fricatives. (si)
...
### Telugu – lyrical aspiration – te – Telugu placeholder centred on aspirated retroflexes, velar nasals, and diphthong glides. (te)
...
### Urdu – poetic glide – ur – Urdu placeholder capturing retroflex flaps and aspirated stops used in ghazal recitation and newscasts. (ur)
...
### Chinese (Mandarin) – tonal baseline – zh-CN – Mandarin placeholder emphasising neutral tones, retroflex affricates, and aspect particles. (zh-CN)
