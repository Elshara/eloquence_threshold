...
5. **Summarise cross-source assets** – run `python tools/summarize_language_assets.py --json docs/language_asset_summary.json --markdown docs/language_asset_summary.md --print` to validate that the refreshed coverage, progress, voice template, and research snapshots line up before packaging.
